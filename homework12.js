...
// генеруємо випадковий індекс - Math.random() генерує чісло від 0 до 1, Math.floor() округлює до цілого
...
// обмінюємось значеннями між поточним елементом arr[i] та випадковим елементом arr[randomIndex]
    ...
    return arr; // кинець нашого циклу -> повертаємо наш перемишаній масив
}
